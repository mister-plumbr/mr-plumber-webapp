      ...
      <main className="flex flex-1 items-center justify-center px-4 py-12">
        <div className="w-full max-w-md rounded-[16px] border border-[#dadbdd] bg-white p-8 shadow-sm">
          ...
          <div className="mt-8 flex items-center gap-4">
            <div className="h-px flex-1 bg-[#dadbdd]" />
          ...
          <button
            type="button"
            className="mt-6 flex w-full items-center justify-center gap-2 rounded-[8px] border border-[#dadbdd] bg-white px-6 py-3.5 text-[16px] font-semibold text-[#222325] hover:bg-[#f9f9f9] transition-colors"
          >
            <svg
              width="20"
              height="20"
